...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.research-card, .timeline-item, .skill-category, .award-item, .publication-item');
    ...
    skillLevels.forEach(skill => {
        ...
        skill.style.transition = 'all 1s ease-in-out';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const revealElements = document.querySelectorAll('.timeline-content, .research-card, .publication-item');
